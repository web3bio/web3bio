...
const CanvasMenu: React.FC<{
  ...
  const handleEnableSearch = () => {
    ...
    setEnableSearch((old) => {
      ...
      // 设置 menuTip
      setMenuTip({
        text: 'Enter the node id and press submit',
        display: 'block',
        opacity: 1,
      });
      return true;
  ...
  const toggleFishEye = () => {
    ...
    if (fisheyeEnabled && fishEye) {
      ...
      // 设置 menuTip
      setMenuTip({
        text: 'Press Esc to exit the fisheye magnifier',
        display: 'none',
        opacity: 0,
      });
    } else {
  ...
  const enabledLassoSelect = () => {
    ...
    if (!lassoEnabled) {
      ...
      // 设置 menuTip
      setMenuTip({
        text: 'Press Esc to exit cable selection mode',
        display: 'block',
        opacity: 1,
      });
    } else {
  ...
  const handleEnableSelectPathEnd = () => {
    setEnableSelectPathEnd((old) => {
      if (!old) {
        ...
        // 设置 menuTip
        setMenuTip({
          text: 'Hold down the SHIFT key and click on two nodes to start and end the path',
          display: 'block',
          opacity: 1,
        });
        return true;
  ...
  const escListener = (e) => {
    ...
    // 设置 menuTip
    setMenuTip({
      text: 'Press Esc to exit the current mode',
      display: 'none',
      opacity: 0,
    });
  };
      ...
      <div id="canvas-menu">
        <div className="icon-container">
          <span
            ...
            onMouseEnter={(e) =>
              showItemTip(e, edgeLabelVisible ? 'Hide edge labels' : 'Show edge labels')
            }
          ...
          <span
            ...
            onMouseEnter={(e) =>
              showItemTip(e, fisheyeEnabled ? 'Close up of fisheye magnifying glass' : 'Open fisheye magnifying glass')
            }
            onMouseLeave={hideItemTip}
          >
            {fisheyeEnabled ? (
          ...
          <span
            ...
            onMouseEnter={(e) =>
              showItemTip(e, lassoEnabled ? 'Turn off cable selection mode' : 'Open cable selection mode')
            }
            onMouseLeave={hideItemTip}
          >
          ...
          <span
            ...
            onMouseEnter={(e) => showItemTip(e, 'search shortest path')}
            onMouseLeave={hideItemTip}
          >
          ...
          <span className="icon-span" style={{ width: 'fit-content', ...iconStyle.disable }}>
            ...
            <span
              ...
              onMouseEnter={(e) => showItemTip(e, 'Figure content adaptation container, shortcut key: ctrl + 1')}
              onMouseLeave={hideItemTip}
            ...
            <span
              ...
              onMouseEnter={(e) => showItemTip(e, 'enlarge')}
              onMouseLeave={hideItemTip}
            >
              +
            </span>
          ...
          <span
            ...
            onMouseEnter={(e) => showItemTip(e, 'Enter ID to search for nodes')}
            onMouseLeave={hideItemTip}
          >
          ...
          {enableSearch && (
            <span
              onMouseEnter={(e) => showItemTip(e, 'Enter the node ID to be searched and click the Submit button')}
              onMouseLeave={hideItemTip}
            >
          ...
          {enableSelectPathEnd && (
            <span
              onMouseEnter={(e) =>
                showItemTip(e, 'Select one and only two nodes as endpoints and click the Find Path button')
              }
              onMouseLeave={hideItemTip}
            >
