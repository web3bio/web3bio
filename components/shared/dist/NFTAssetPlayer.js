...
var RenderNFTAssetPlayer = function (props) {
    var _a = props.type, type = _a === void 0 ? "image/png" : _a, className = props.className, src = props.src, contentUrl = props.contentUrl, width = props.width, height = props.height, alt = props.alt, onClick = props.onClick;
    return (React.createElement(React.Fragment, null, src ?
        React.createElement("div", { onClick: onClick, className: className }, IsImage(type) ? (React.createElement(ImageLoader_1.ImageLoader, { width: width, height: height, src: src, alt: alt, loading: "lazy" })) : isVideo(type) && (React.createElement("video", { style: { borderRadius: 8 }, className: "video-responsive", width: "100%", height: "100%", muted: true, autoPlay: true, loop: true, poster: src },
            React.createElement("source", { src: contentUrl, type: type }))))
        :
            React.createElement("div", { onClick: onClick, className: className },
