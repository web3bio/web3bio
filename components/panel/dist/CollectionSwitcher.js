...
var RenderCollectionSwitcher = function (props) {
    ...
    return (React.createElement("div", { className: "collection-switcher" },
        React.createElement("div", { className: "collection-list" }, collections.map(function (item) { return (React.createElement("div", { onClick: function () { return hideDropdownMenu(item); }, className: item.key === currentSelect
