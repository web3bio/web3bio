...
var RenderNFTCollections = function (props) {
    ...
    react_1.useEffect(function () {
        ...
        if (data && data.data) {
            ...
            var judgeActiveCollection_1 = function () {
                if (data && data.data) {
                    var nav_contentRect = container.getBoundingClientRect();
                    var groupList = Array.from(data.data.map(function (x) { return document.getElementById(x.contract_address); }));
                    if (nav_contentRect) {
