    ...
    react_1.useEffect(function () {
        ...
        if (router.query.s) {
            ...
            if (!router.query.platform) {
                var searchPlatform_1 = utils_1.handleSearchPlatform(searchkeyword);
        ...
        React.createElement("main", { className: "web3bio-container" },
            ...
            React.createElement("div", { className: searchFocus ? "web3bio-search focused" : "web3bio-search" },
                React.createElement("div", { className: "container grid-xs" },
                    ...
                    searchPlatform ? (utils_1.isDomainSearch(searchPlatform) ? (React.createElement(SearchResultDomain_1.SearchResultDomain, { searchTerm: searchTerm, searchPlatform: searchPlatform })) : (React.createElement(SearchResultQuery_1.SearchResultQuery, { searchTerm: searchTerm, searchPlatform: searchPlatform }))) : null)),
