...
function Home() {
    ...
    return (React.createElement("div", null,
        ...
        modalOpen && (React.createElement(____domain_1["default"], { asComponent: true, onClose: function () { return setModalOpen(false); }, domain: [profileIdentity.displayName || profileIdentity.identity], overridePlatform: profilePlatform }))));
}
